...
class NameCoref:
	...
	def __init__(self, aliasFile):
		# we save the honorifics and the list of possible aliases in english
	...
	# this is the actual function which performs entities clustering
	def name_cluster(self, entities, is_named, existing_refs): # existing refs
		...
		for i, val in enumerate(is_named):
			if val == 1: # when the entity is NAMED
